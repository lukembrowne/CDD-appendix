...
This tutorial follows from Section 2. "Modeling considerations when estimating CDD" of the main text. \## Overview
...
::: callout-note
Note: The code is adapted from [@hulsmann2024latitudinal] and the [latitudinalCNDD repository](https://github.com/LisaHuelsmann/latitudinalCNDD/tree/main/code) by Lisa Hüelsmann. 
:::
